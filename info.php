  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6 md:gap-10">
    ...
    <div class="size-full bg-white shadow-lg rounded-lg p-5 dark:bg-neutral-900">
      <div class="flex items-center gap-x-4 mb-3">
        ...
        <div class="shrink-0">
          <h3 class="block text-lg font-semibold text-gray-800 dark:text-white">GitLocker</h3>
        </div>
      </div>
      <a href="https://www.gitlocker.com"><p class="text-gray-600 dark:text-neutral-400">The simplest way to keep your portfolio always up-to-date.</p></a>
    </div>
    <!-- End Card -->
